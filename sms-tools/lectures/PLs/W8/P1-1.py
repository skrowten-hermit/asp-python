...
"""
P1-1: STFT transformations - creating a filter
...
window_type_xw = 'hanning'
window_type_fltr = 'hamming'
t = -60

w = get_window(window_type_xw, M)
xw = x[10000:10000 + M] * w
filter = get_window(window_type_fltr, 30) * t
